...
class AppContext(ApplicationContext):           # 1. Subclass ApplicationContext
    def run(self):                              # 2. Implement run()
        ...
        # vbox1.addWidget(numeratorLabel,0, 0, 1, 1)
        # vbox1.addWidget(denominatorLabel,0, 1, 1, 1)
        # vbox2.addWidget(numeratorSlider,1, 0, 1, 1)
        # vbox2.addWidget(denominatorSlider,1, 1, 1, 1)
